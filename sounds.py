...
print ("There are 40 phonemes in english")
print ("They are also split into vowels and consonants")
print ("Vowels are split into 4 groups: Short, Long, R-defined and Gliding")
print ()
print ("Short vowels:")
print ("(a) as in cat")
print ("(e) as in get")
...
print ("(e*) as in err")
print ("(i*) as in bird")
print ("(o*) as in origin")
print ("(u*) as in pure")
print ()
print ("Gliding Vowels:")
print ("(ear) as in near")
print ("(oy) as in boy")
print ("(oo) as in food")
print ("(ow) as in cow or mouth")
print ()
...
print ("Fricatives: (f), (v), (th), (s), (z), (sh), (h)")
print ("Nasals: (m), (n), (ng)")
        ...
        if word[0] in vowels:
            ...
            if word.startswith("sh"):
                ...
                if word[1:2] in "eiy":
                    ...
                    previous_letter = "c"
                    word = word[1:]
            elif word[0] in "pbtdkgjfvszhmnlrwz":
                sound.append(f"({word[0]})")
                previous_letter = word[0]
                word = word[1:]
            else:
